    ...
    return (
        <div className={styles.container}>
            ...
            <p className={styles.marginFromTitle}>
                ...
                <code className={styles.codeError}>API_KEY</code> are not
                configured in your{' '}
                <code className={styles.codeError}>.env.local</code> file.
            </p>
            <p className={styles.marginFromCode}>
                Please create a{' '}
                <code className={styles.codeError}>.env.local</code> file with:
            </p>
